...
# (and if they guess a letter that is not in availableLetters, you should 
# print a message telling them they've already guessed that - so try again!).
# Sample Output
...
def hangman(secretWord):
    ...
    * After each round, you should also display to the user the 
    ...
    for guesses in range(numberOfGuesses,0,-1):
        print('-------------')
