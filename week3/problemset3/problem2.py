...
# This is called usability - it's very important, when programming, to 
# consider the usability of your program. If users find your program difficult 
# to understand or operate, they won't use it!
# For this problem, you are free to use spacing in any way you wish - our 
# grader will only check that the letters and underscores are in the proper 
# order; it will not look at spacing. We do encourage you to think about 
# usability when designing.
...
lettersGuessed = ['z', 'x', 'q', 'm', 'a', 'o', 's', 't', 'e', 'e']
print(getGuessedWord(secretWord, lettersGuessed))
