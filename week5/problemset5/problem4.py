'''
Created on Tue Feb 20 17:01 2018
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for s in range(26):
          # print(self.get_message_text(), self.apply_shift(s))
...
def decrypt_story():
  ...
  ciphertext = CiphertextMessage(story_encrypted)
  return ciphertext.decrypt_message()

print(decrypt_story())
print(is_word(load_words(WORDLIST_FILENAME), 'reportedly'))

# Correct = (16, 'Jack Florey is a mythical character created on the spur of a moment to help cover an insufficiently planned hack. He has been registered for classes at MIT twice before, but has reportedly never passed a class. It has been the tradition of the residents of East Campus to become Jack Florey for a few nights each year to educate incoming students in the ways, means, and ethics of hacking.')
