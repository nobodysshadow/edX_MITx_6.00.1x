...
def test_calculateHandlen():
    ...
    # test 1
    hand = {'r': 1, 'a': 3, 'p': 2, 'e': 1, 't': 1, 'u':1}
    feedback = calculateHandlen(hand)
    if not feedback == 9:
        print("FAILURE: test_calculateHandlen()")
        print("\tExpected 9, but got " + feedback + " for hand:", hand)
        failure = True        
    ...
    if not feedback == 8:
        print("FAILURE: test_calculateHandlen()")
        print("\tExpected 8, but got " + feedback + " for hand:", hand)
        failure = True        
    ...
    if not feedback == 7:
        print("FAILURE: test_calculateHandlen()")
        print("\tExpected 7, but got " + feedback + " for hand:", hand)
        failure = True        
        
    # test 5
    hand = {'e':1, 'v':2, 'n':1, 'i':1, 'l':2, 'a': 3, 'p': 2}
    feedback = calculateHandlen(hand)
    if not feedback == 12:
        print("FAILURE: test_calculateHandlen()")
        print("\tExpected 12, but got " + feedback + " for hand:", hand)
        failure = True        
    ...
    if not feedback == 0:
        print("FAILURE: test_calculateHandlen()")
        print("\tExpected 0, but got " + feedback + " for hand:", hand)
        failure = True        
    ...
    if not feedback == 1:
        print("FAILURE: test_calculateHandlen()")
        print("\tExpected 1, but got " + feedback + " for hand:", hand)
        failure = True        
